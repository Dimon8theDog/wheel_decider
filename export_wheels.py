...
wheels = [
    ...
    },
    {
        ...
        "ev": 33.77,
        "sectors": [
            ("€25",      25.00,  26.26, False),
            ("€30",      30.00,  22.61, False),
            ("€35",      35.00,  18.85, False),
            ("75 HB FS", 37.50,  14.96, False),
            ("€40",      40.00,  10.87, False),
            ("€60",      60.00,   6.45, False),
            ("€75",      75.00,   0.00, True),
            ("€80",      80.00,   0.00, True),
        ]
    },
    {
        ...
        "ev": 62.40,
        "sectors": [
            ("100 HB FS",50.00,   0.00, True),
            ("€25",      25.00,   0.00, True),
            ("€30",      30.00,   0.00, True),
            ("€35",      35.00,   0.00, True),
            ("€40",      40.00,  27.78, False),
            ("€60",      60.00,  26.33, False),
            ("€75",      75.00,  24.42, False),
            ("€80",      80.00,  21.47, False),
        ]
    },
]
